document.getElementById('idts').onclick = (event) => {
    ...
    event.preventDefault();
    { location.href= '/Overview';}};document.getElementById('icitrl').onclick = (event) => {
    event.preventDefault();
    { location.href= '/Contract';}};document.getElementById('i4k98').onclick = (event) => {
    event.preventDefault();
    { window.document.location = '#submenu1';}};document.getElementById('i9vat').onclick = (event) => {
    event.preventDefault();
    { location.href= '/Pre-Assessment';}};document.getElementById('iix52a').onclick = (event) => {
    event.preventDefault();
